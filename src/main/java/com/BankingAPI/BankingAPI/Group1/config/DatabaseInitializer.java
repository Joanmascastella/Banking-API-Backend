...
public class DatabaseInitializer implements ApplicationRunner {
    ...
    private void initDatabase() {
        Users newUsers = new Users("johndoe", "john.doe@example.com", "John", "Doe", "123456789", "0123456789", LocalDate.of(1990, 1, 1), 5000.0, 100.0, true, UserType.ROLE_CUSTOMER, bCryptPasswordEncoder.encode("123"));
